...
function [N,x,xh1,eq]=PHbox(L,lum,bins,alpha,nh,ratio,Ac,iterations,xh1i,xhe1i,xhe3i,T0,rs)
  ...
  while T<iterations
    ...
    [N,mini,totalH1,totalHe1,totalHe2,totalGH1,totalGHe1,totalGHe2]=GAmodel(N,x,nh,nhe,sigmaH1,sigmaHe1,sigmaHe2,Nc,L,xh1,xhe1,xhe3,bins,vH1,vHe1,vHe2);         #Gas acts on the photons
